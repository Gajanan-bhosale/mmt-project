        ...
        stage('Upload the docker Image to Nexus') {
              steps {
                    script {
                         ...
                         sh 'docker login http://13.127.224.61:8085/repository/mmt-project/ -u admin -p ${PASSWORD}'
                         echo "Push Docker Image to Nexus : In Progress"
                         sh 'docker tag mmt-project 13.127.224.61:8085/mmt-project:dev-mmt-project-v.1.${BUILD_NUMBER}'
                         sh 'docker push 13.127.224.61:8085/mmt-project:dev-mmt-project-v.1.${BUILD_NUMBER}'
